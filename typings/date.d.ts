...
declare function getDateInfoNWeek(dd: Date, day: number, showToday?: boolean = false): Object<WeekdayType>;
...
export declare function getMonthDay(isFillBlank?: boolean = false, isFirstDayMonday?: boolean = false, customDate?: Date = new Date()): Array<MonthDayType>;